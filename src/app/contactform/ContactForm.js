            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 col-sm-12 col-lg-6 col-xl-6">
                        <input type="text" className="form-control" placeholder="Contact Number" value={cnumber} onChange={(e)=>setCnumber(e.target.value)} required/>
                    </div>
                    <div className="col-md-6 col-sm-12 col-lg-6 col-xl-6">
                        <input type="text" className="form-control" placeholder="Mail Id" value={mailid} onChange={(e)=>setMailid(e.target.value)} required/>
                    </div>
                    <div className="col-md-12 col-sm-12 col-lg-12 col-xl-12">
